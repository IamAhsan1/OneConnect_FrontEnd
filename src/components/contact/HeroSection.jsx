    ...
    >
      ...
      <div className="container relative mx-auto px-6">
        <div className="mx-auto flex max-w-4xl flex-col items-center text-center">
          ...
          <span className="mb-6 inline-flex items-center rounded-full border border-blue-200 bg-blue-100 px-4 py-1.5 text-sm font-semibold text-blue-700">
            {heroData.badge}
          </span>
          ...
          <div className="mt-10 flex w-full flex-col justify-center gap-4 sm:w-auto sm:flex-row">
            ...
            >
              <a
                ...
                aria-label={heroData.primaryButton.text}
              >
                <MessageCircle
                  aria-hidden="true"
            ...
            >
              <a
                ...
                aria-label={heroData.secondaryButton.text}
              >
